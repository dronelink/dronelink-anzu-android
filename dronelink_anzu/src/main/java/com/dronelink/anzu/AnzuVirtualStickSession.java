...
public class AnzuVirtualStickSession implements DroneControlSession, VirtualStickStateListener {
    private static final String TAG = AnzuVirtualStickSession.class.getCanonicalName();
    ...
    public AnzuVirtualStickSession(final Context context, final AnzuDroneAdapter droneAdapter) {
    ...
    public Message getDisengageReason() {
        ...
        if (state == State.FLIGHT_MODE_JOYSTICK_COMPLETE) {
            ...
            if (reason != null) {
                return new Message(context.getString(R.string.MissionDisengageReason_drone_control_override_title), DronelinkAnzu.getString(context, reason));
            }
